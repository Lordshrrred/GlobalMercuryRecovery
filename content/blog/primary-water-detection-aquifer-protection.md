...
2. **Which sources are most vulnerable?** Springs, shallow wells, and downstream intakes may face different risk profiles.

3. **Where can safe infrastructure be placed?** Water systems should be located with contamination pathways in mind.

4. **What needs monitoring?** Sampling should focus on likely exposure points, not only convenient locations.

5. **How does the basin change seasonally?** Rainfall, mining activity, and erosion can change risk over time.
