...
1. **Map the material.** Different piles can have different chemistry, particle size, moisture, and contaminant behavior.

2. **Test before scaling.** Bench tests and pilot processing help determine whether recovery, stabilization, or containment is the right first move.

3. **Control water movement.** Water is often the pathway that carries contamination away from the site.

4. **Stabilize what remains.** After any value recovery, the remaining material still needs a land-safe plan.

5. **Verify over time.** A tailings project is not finished the day equipment leaves. Monitoring confirms whether the land is actually becoming safer.
